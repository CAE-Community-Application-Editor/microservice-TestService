...
/**
 *
 * TestService - Test Class
 *
 * This class provides a basic testing framework for the microservice TestService. It was
...
public class MyTestServiceTest {
  ...
  private static final ServiceNameVersion testTemplateService = new ServiceNameVersion(MyTestService.class.getCanonicalName(),"0.1");

  private static final String mainPath = "myResource";
